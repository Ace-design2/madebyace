...
import { FiMail, FiHome, FiSun, FiMoon, FiGithub, FiLinkedin, FiTwitter } from "react-icons/fi";
    ...
    <div className={`fixed top-4 sm:top-6 left-0 right-0 z-[100] flex justify-center px-2 pointer-events-none transition-all duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)] ${isLoading ? "opacity-0 -translate-y-10" : "opacity-100 translate-y-0"}`}>
      ...
      <nav className="pointer-events-auto px-1.5 sm:px-3 py-1.5 sm:py-2 bg-black/5 dark:bg-white/[0.03] backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-full inline-flex justify-center items-center gap-0.5 sm:gap-2 shadow-[0_8px_32px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-500 hover:bg-black/10 dark:hover:bg-white/[0.05] hover:border-black/20 dark:hover:border-white/20">
        ...
        <div className="relative flex items-center gap-2" ref={contactRef}>
          ...
          <div
            className={`absolute top-full right-0 mt-4 w-60 sm:w-64 bg-white/95 dark:bg-black/95 backdrop-blur-3xl border border-black/10 dark:border-white/10 rounded-lg p-2 shadow-2xl transition-all duration-300 origin-top-right ${
          ...
          >
            <div className="flex flex-col space-y-1">
              <a href="mailto:showunmioluwasegun135@gmail.com" className="flex items-center gap-3 p-3 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition-colors group">
              ...
              <a href="https://github.com/Ace-design2" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition-colors group">
                <div className="w-9 h-9 rounded-full bg-red-500/10 flex items-center justify-center text-red-500 group-hover:bg-red-500 group-hover:text-white transition-all">
                  <FiGithub className="w-4 h-4" />
                </div>
                <div className="flex flex-col">
                  <span className="text-black dark:text-white text-sm font-bold">GitHub</span>
                  <span className="text-gray-500 dark:text-gray-400 text-[10px] uppercase tracking-wider">View my code</span>
                </div>
              </a>
              <a href="https://www.linkedin.com/in/showunmi-oluwasegun-50015124b/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition-colors group">
                <div className="w-9 h-9 rounded-full bg-red-500/10 flex items-center justify-center text-red-500 group-hover:bg-red-500 group-hover:text-white transition-all">
                  <FiLinkedin className="w-4 h-4" />
                </div>
                <div className="flex flex-col">
                  <span className="text-black dark:text-white text-sm font-bold">LinkedIn</span>
                  <span className="text-gray-500 dark:text-gray-400 text-[10px] uppercase tracking-wider">Connect with me</span>
                </div>
              </a>
              <a href="https://x.com/madebyacee" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition-colors group">
                <div className="w-9 h-9 rounded-full bg-red-500/10 flex items-center justify-center text-red-500 group-hover:bg-red-500 group-hover:text-white transition-all">
                  <FiTwitter className="w-4 h-4" />
                </div>
                <div className="flex flex-col">
                  <span className="text-black dark:text-white text-sm font-bold">Twitter</span>
                  <span className="text-gray-500 dark:text-gray-400 text-[10px] uppercase tracking-wider">Follow along</span>
                </div>
              </a>
            </div>
          </div>
